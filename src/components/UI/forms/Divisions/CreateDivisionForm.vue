<template>
  <form @submit.prevent="onSubmit">
    <h2 class="text-3xl font-normal mb-6">Pridėkite naują padalinį:</h2>

    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div>
        <div class="mb-4">
          <label for="divisionName" class="block text-sm font-normal text-gray-700">Padalinio pavadinimas:</label>
