                ...
                <div>
                    ...
                    <div class="space-y-2">
                        <div class="flex">
                            ...
                            <a href="mailto:example@teltonika.lt" class="text-[#1F3F77] hover:underline">example@teltonika.lt</a>
                        </div>
                        <div class="flex">
